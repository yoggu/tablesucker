...
function PlayersSkeletonItem() {
  return (
    <li className="flex animate-fade-in justify-between border-b border-slate-700 pb-4 lg:col-span-1 last:border-b-0 last:pb-0 lg:[&:nth-last-child(-n+2)]:border-b-0 lg:[&:nth-last-child(-n+2)]:pb-0">
