  ...
  return (
    <ul className="flex flex-col gap-6">
      {games?.map((game) => (
        <li
          key={game.id}
          className="grid grid-cols-[minmax(80px,1fr)_minmax(0,100px)_minmax(80px,1fr)] gap-2 border-b pb-4 last:border-0 last:pb-0 sm:gap-4 md:gap-8 xl:gap-12 dark:border-slate-700"
        >
