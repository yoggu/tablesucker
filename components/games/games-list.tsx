  ...
  return (
    ...
    >
      {games?.map((game) => (
        <li
          key={game.id}
          className="relative grid animate-fade-in grid-cols-[minmax(80px,1fr)_minmax(0,100px)_minmax(80px,1fr)] gap-2 border-b border-border pb-4 last:border-0 last:pb-0 sm:gap-4 md:gap-8 xl:gap-12"
        >
