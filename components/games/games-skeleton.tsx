...
function GameListItemSkeleton() {
  return (
    <li className="grid grid-cols-[minmax(80px,1fr)_minmax(0,100px)_minmax(80px,1fr)] gap-2 border-b border-slate-700 pb-4 last:border-0 last:pb-0 sm:gap-4 md:gap-8 xl:gap-12">
      ...
      <div className="flex flex-col items-center justify-end">
        <span className="text-4xl lg:text-5xl flex gap-0.25">
          <Skeleton className="h-14 w-6" />:<Skeleton className="h-14 w-6" />
        </span>
      </div>
      <div className="flex flex-col gap-3">
        <div className="flex">
