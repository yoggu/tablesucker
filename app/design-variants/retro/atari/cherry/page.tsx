...
export default function AtariCherryPage() {
  return (
    <div className="min-h-screen bg-[#1a0a0f] p-6 lg:p-8">
      <div className="mx-auto max-w-7xl">
        <header className="mb-8">
          <Link
            href="/design-variants/retro/atari"
            className="mb-3 inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-[#FF6B6B] transition-colors hover:text-[#DC143C]"
          >
            <span className="text-lg">◄</span> Back to Atari Variants
          </Link>
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <h1 className="text-4xl font-black uppercase tracking-tight text-[#FF6B6B] lg:text-5xl [text-shadow:4px_4px_0_#DC143C]">
                Cherry Arcade
              </h1>
              <p className="mt-2 text-base font-medium text-[#FF6B6B]/70">
        ...
        <footer className="mt-8 border-t-4 border-[#DC143C]/30 pt-6 text-center">
          <p className="text-sm font-medium uppercase tracking-widest text-[#FF6B6B]/50">
            Tablesucker • Atari Cherry Theme • {new Date().getFullYear()}
          </p>
        </footer>
      </div>
    </div>
