...
// Chart colors for Cool Blue theme
const chartColors = {
  primary: "#00DDFF",
  secondary: "#0088FF",
  accent: "#66EEFF",
  ...
  grid: "#0088FF30",
  text: "#00DDFF",
  lines: ["#0088FF", "#00DDFF", "#00AAFF", "#66EEFF"],
};

export default function AtariCoolPage() {
  return (
    <div className="min-h-screen bg-[#0a1628] p-6 lg:p-8">
      <div className="mx-auto max-w-7xl">
        {/* Header */}
        <header className="mb-8">
          <Link
            href="/design-variants/retro/atari"
            className="mb-3 inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-[#00DDFF] transition-colors hover:text-[#0088FF]"
          >
            <span className="text-lg">◄</span> Back to Atari Variants
          </Link>
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <h1 className="text-4xl font-black uppercase tracking-tight text-[#00DDFF] lg:text-5xl [text-shadow:4px_4px_0_#0088FF]">
                Cool Blue
              </h1>
              <p className="mt-2 text-base font-medium text-[#00DDFF]/70">
        ...
        {/* Footer */}
        <footer className="mt-8 border-t-4 border-[#0088FF]/30 pt-6 text-center">
          <p className="text-sm font-medium uppercase tracking-widest text-[#00DDFF]/50">
            Tablesucker • Atari Cool Blue Theme • {new Date().getFullYear()}
          </p>
        </footer>
      </div>
    </div>
