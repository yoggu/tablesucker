...
--
-- Name: season_state; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: team; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: create_game(integer, integer, integer, integer[], integer[]); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.create_game(p_season_id integer, p_team_red_score integer, p_team_blue_score integer, p_team_red_players integer[], p_team_blue_players integer[]) RETURNS TABLE(game_id integer)
    LANGUAGE plpgsql
    AS $$
DECLARE
    new_game_id INTEGER;
...
--
-- Name: update_game(integer, integer, integer[], integer, integer[], integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_game(p_game_id integer, p_season_id integer, p_team_red_players integer[], p_team_red_score integer, p_team_blue_players integer[], p_team_blue_score integer) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    -- Update the game
    UPDATE games
    SET season_id = p_season_id, team_red_score = p_team_red_score, team_blue_score = p_team_blue_score
    WHERE id = p_game_id;

    -- Remove existing player associations
    DELETE FROM game_players WHERE game_id = p_game_id;

    -- Insert new player associations for team red
    INSERT INTO game_players (game_id, player_id, team)
    SELECT p_game_id, unnest(p_team_red_players), 'team_red';

    -- Insert new player associations for team blue
    INSERT INTO game_players (game_id, player_id, team)
...
--
-- Name: channel_name(); Type: FUNCTION; Schema: realtime; Owner: supabase_admin
--
...
ALTER FUNCTION realtime.channel_name() OWNER TO supabase_admin;
...
--
-- Name: seasons_with_state; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.seasons_with_state AS
 SELECT seasons.id,
    seasons.created_at,
    seasons.start_date,
    seasons.end_date,
        CASE
            WHEN (seasons.start_date > CURRENT_DATE) THEN 'upcoming'::public.season_state
            WHEN ((seasons.end_date IS NULL) OR (seasons.end_date >= CURRENT_DATE)) THEN 'active'::public.season_state
            ELSE 'completed'::public.season_state
        END AS state
   FROM public.seasons;


ALTER TABLE public.seasons_with_state OWNER TO postgres;
...
--
-- Name: channels; Type: TABLE; Schema: realtime; Owner: supabase_admin
--
...
ALTER TABLE realtime.channels OWNER TO supabase_admin;

--
-- Name: channels_id_seq; Type: SEQUENCE; Schema: realtime; Owner: supabase_admin
--
...
ALTER TABLE realtime.channels_id_seq OWNER TO supabase_admin;

--
-- Name: channels_id_seq; Type: SEQUENCE OWNED BY; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: channels id; Type: DEFAULT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: channels channels_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: channels_name_index; Type: INDEX; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: games game_notification; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER game_notification AFTER INSERT ON public.games FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://tablesucker.vercel.app/api/send-notification', 'POST', '{"Content-type":"application/json"}', '{}', '1000');
...
--
-- Name: game_players Enable delete for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: games Enable delete for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: seasons Enable delete for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: game_players Enable insert for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: games Enable insert for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: players Enable insert for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: seasons Enable insert for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: subscriptions Enable insert for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: game_players Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: seasons Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: subscriptions Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: game_players Enable update for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: games Enable update for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: players Enable update for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: seasons Enable update for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: channels; Type: ROW SECURITY; Schema: realtime; Owner: supabase_admin
--

ALTER TABLE realtime.channels ENABLE ROW LEVEL SECURITY;

--
-- Name: objects Give all users access to insert  images 1qv96sy_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Give all users access to insert  images 1qv96sy_0" ON storage.objects FOR INSERT WITH CHECK ((bucket_id = 'players'::text));


--
-- Name: objects Give anon users access to update images 1qv96sy_2; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Give anon users access to update images 1qv96sy_2" ON storage.objects FOR UPDATE USING ((bucket_id = 'players'::text)) WITH CHECK (true);
...
--
-- Name: FUNCTION create_game(p_season_id integer, p_team_red_score integer, p_team_blue_score integer, p_team_red_players integer[], p_team_blue_players integer[]); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION update_game(p_game_id integer, p_season_id integer, p_team_red_players integer[], p_team_red_score integer, p_team_blue_players integer[], p_team_blue_score integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION channel_name(); Type: ACL; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: TABLE game_details; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE seasons_with_state; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.seasons_with_state TO anon;
GRANT ALL ON TABLE public.seasons_with_state TO authenticated;
GRANT ALL ON TABLE public.seasons_with_state TO service_role;
...
--
-- Name: TABLE channels; Type: ACL; Schema: realtime; Owner: supabase_admin
--

GRANT ALL ON TABLE realtime.channels TO postgres;
GRANT ALL ON TABLE realtime.channels TO dashboard_user;
GRANT SELECT,UPDATE ON TABLE realtime.channels TO anon;
GRANT SELECT,UPDATE ON TABLE realtime.channels TO authenticated;
GRANT SELECT,UPDATE ON TABLE realtime.channels TO service_role;


--
-- Name: SEQUENCE channels_id_seq; Type: ACL; Schema: realtime; Owner: supabase_admin
--
